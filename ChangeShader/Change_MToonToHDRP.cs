/*
 * MToonシェーダー　→　HDRP Litシェーダーへ置換するUnityエディタ拡張スクリプト
 *
 * (C)2020 slip
...
namespace VRM
{
    public class Change_MToonToHDRP : ScriptableWizard
    {
        ...
        {
            var wiz = ScriptableWizard.DisplayWizard<Change_MToonToHDRP>(
        ...
        void OnWizardCreate()
        {
            ...
            //変更後のシェーダーを設定
            Shader changeShader = Shader.Find(ShaderName_HDRP);
